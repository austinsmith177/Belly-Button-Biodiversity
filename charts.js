...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleID = sampleResults.otu_ids;
    console.log(sampleID);

    var sampleLabels = sampleResults.otu_labels;
    ...
    var yticks = sampleID.map(Id => "OTU " + Id).slice(0,10).reverse();
    console.log(yticks);
    ...
    var wFreq = parseFloat(sampleMetadata.wfreq);
    console.log(wFreq);
